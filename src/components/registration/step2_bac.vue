<template>
  <div class="xfv-container">
    <step step="2"></step>
    <div class="xfv-from">
      <div class="address_cont rightSan"> <!-- :disabled="seledisab"-->
         <x-address class="address_list" title="派出所/社区" v-model="formData.address" :list="addressList"  placeholder = "请输入派出所/社区" @on-shadow-change="areaChange"></x-address>
